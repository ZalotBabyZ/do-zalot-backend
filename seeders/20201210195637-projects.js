    ...
    return queryInterface.bulkInsert('projects', [
      {
        ...
        description:
          ' อัลตรอน หุ่นยนต์แอนดรอยด์สร้างโดย ดร.เฮนรี่ แฮงค์ พีม เพื่อให้มีกระบวนการคิดและมีอารมณ์แบบมนุษย์ ผิดพลาด มันไม่สามารถควบคุมอารมณ์ได้เลยเปลี่ยนความรู้สึกทั้งหมดไปเกลียดและมีความุ่งหวังที่จะฆ่าล้างโลกไม่ให้มีมนุษย์แทน ความสามารถของอัลตรอนคือมันพัฒนาตัวเองได้รวมถึงถูกสร้างใหม่ได้อีกหลายครั้ง',
        project_vip: false,
